...
const ResoTable: any = ({ initProps, ...props }, ref = null) => {
        ...
        <StickyLeftTableCell className={classes.stickyLeft} padding="checkbox">
          {checkboxSelection?.type === 'checkbox' && (
            <Checkbox
              ...
              checked={data && data?.list?.length > 0 && checkAllCurrentData}
      ...
      <Container style={{ padding: 0 }}>
        ...
        {pagination && (
          <TablePagination
            ...
            component="div"
            {...{ rowsPerPage: pageSize || 10, count: total || 1, page: current || 2 - 1 }}
            onPageChange={(_, page: any) => changeCurrent(page + 1 || 1)}
            onRowsPerPageChange={(e: any) => changePageSize(e.target.value || 1)}
          />
        )}
      </Container>
    </FormProvider>
